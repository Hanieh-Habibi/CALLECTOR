...
$userID = $_SESSION[SessionIndex['UserID']];

$countriesList = get_countries_list("CountryID",true, $_SESSION[SessionIndex['UserInfo']]['CountryID']);
$gendersList = get_genders_list("GenderID",true, $_SESSION[SessionIndex['UserInfo']]['GenderID']);

?>
<html>
<head>
    <meta charset="UTF-8">
    <title>Settings | Callector community</title>
								...
								<div class="tab-pane fade show active" id="nav-acc" role="tabpanel" aria-labelledby="nav-acc-tab">
									<div class="acc-setting">
										...
										<form method="POST" id="UserProfileForm" enctype='multipart/form-data'>
                                            <input type="hidden" id="task" name="task" value="save_user_profile">
                                            <input type="hidden" id="UserID" name="UserID" value=<?php echo '"' . $userID . '"'; ?>>
                                            <div class="cp-field">
                                                <h5>User name : </h5> <B> <?php echo $_SESSION[SessionIndex['UserName']]; ?></B>
                                            </div>
                                            <div class="cp-field">
                                                <h5>First name</h5>
                                                <div class="cpp-fiel">
                                                    <input type="text" name="FirstName" id="FirstName"
                                                           placeholder="First name" value="<?php echo $_SESSION[SessionIndex['UserInfo']]['FirstName']; ?>">
                                                </div>
                                            </div>
                                            <div class="cp-field">
                                                <h5>Middle name</h5>
                                                <div class="cpp-fiel">
                                                    <input type="text" name="MiddleName" id="MiddleName"
                                                           placeholder="Middle name" value="<?php echo $_SESSION[SessionIndex['UserInfo']]['MiddleName']; ?>">
                                                </div>
                                            </div>
                                            <div class="cp-field">
                                                <h5>Last name</h5>
                                                <div class="cpp-fiel">
                                                    <input type="text" name="LastName" id="LastName"
                                                           placeholder="Last name" value="<?php echo $_SESSION[SessionIndex['UserInfo']]['LastName']; ?>">
                                                </div>
                                            </div>
                                            <div class="cp-field">
                                                <h5>Display name</h5>
                                                <div class="cpp-fiel">
                                                    <input type="text" name="DisplayName" id="DisplayName"
                                                           placeholder="Display name" value="<?php echo $_SESSION[SessionIndex['UserInfo']]['DisplayName'] ?>">
                                                </div>
                                            </div>
                                            <div class="cp-field">
                                                <h5>Gender</h5>
                                                <div class="form-group">
                                                    <?php echo $gendersList; ?>
                                                </div>
                                            </div>
                                            <div class="cp-field">
                                                <h5>Country</h5>
                                            ...
                                            <div class="cp-field">
                                                ...
                                                <div class="cpp-fiel">
                                                    <input type="text" name="BirthDate" id="BirthDate"
                                                           placeholder="Birth date" value="<?php echo $_SESSION[SessionIndex['UserInfo']]['BirthDate']; ?>">
                                                </div>
                                            </div>
                                            <div class="cp-field">
                                                <h5>Website</h5>
                                                <div class="cpp-fiel">
                                                    <input type="text" name="WebsiteAddress" id="WebsiteAddress"
                                                           placeholder="Website address" value="<?php echo $_SESSION[SessionIndex['UserInfo']]['WebsiteAddress']; ?>">
                                                </div>
                                            </div>
                                            <div class="cp-field">
                                                <h5>Interests</h5>
                                                <div class="cpp-fiel">
                                                    <input type="text" name="Interests" id="Interests"
                                                           placeholder="Interests" value="<?php echo $_SESSION[SessionIndex['UserInfo']]['Interests']; ?>">
                                                </div>
                                            </div>
                                            <div class="cp-field">
                                                <h5>About me</h5>
                                                <div class="cpp-fiel">
                                                    <input type="text" name="AboutMe" id="AboutMe" placeholder="About me"
                                                           value="<?php echo $_SESSION[SessionIndex['UserInfo']]['AboutMe']; ?>">
                                                </div>
                                            </div>
                                            <div class="notbar">
                                                <h4>Notification Email</h4>
                                                <p>Send me Email when something happens!</p>
                                                <div class="toggle-btn">
                                                    <div class="custom-control custom-switch">
                                                        <input type="hidden" name="EmailNotification" value="no">
                                                        <input type="checkbox" class="custom-control-input"
                                                               id="EmailNotification" name="EmailNotification"
                                                               value="yes" <?php if($_SESSION[SessionIndex['UserInfo']]['EmailNotification'] == 'yes') echo "checked"; ?>>
											...
											<div class="save-stngs">
												<ul>
													<li><button type="button" id="SaveUserSetting" name="SaveUserSetting" onclick="save_user_setting()">Save profile setting</button></li>
													<li><p id="saveSettingResponseMsg" onclick="$( this ).text('');"></p></li>
												</ul>
											</div><!--save-stngs end-->
										</form>
									</div><!--acc-setting end-->
							  		...
							  		<div class="acc-setting">
										...
										<form>
											...
											<div class="save-stngs pd2">
												<ul>
													<li><button type="submit">Save Password</button></li>
												</ul>
											</div><!--save-stngs end-->
										</form>
									</div><!--acc-setting end-->
